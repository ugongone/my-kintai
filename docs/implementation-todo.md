...
### 10.1 デプロイガイド作成
- [x] `docs/deploy-guide.md` 作成
- [x] Vercel設定手順をドキュメント化
- [x] Supabase本番設定手順をドキュメント化
- [x] トラブルシューティング情報を追加
...
#### Supabase本番設定
- [ ] 本番用リダイレクトURL追加（https://your-app.vercel.app/auth/callback）
- [ ] Google OAuthリダイレクトURI更新
- [ ] RLSポリシー確認

#### 動作確認
- [ ] 本番環境でGoogle認証テスト
- [ ] 打刻機能テスト（業務開始・休憩・業務終了）
- [ ] 月次実績ページの表示確認
- [ ] CSV出力機能の動作確認
- [ ] 設定ページで時給更新テスト
